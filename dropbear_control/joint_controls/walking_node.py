...
class HumanoidController(Node):
    def __init__(self):
        ...
        # Display walking information
        self.display_walking_info()
...
║                                                                              ║
║  🚶 WALKING CONTROLLER - RL-POWERED LOCOMOTION                              ║
║  📡 Publishing to: Multiple joint controllers                               ║
║  ⚡ Control Rate: 60Hz effort + 1Hz trajectory                              ║
║  🧠 AI: Reinforcement Learning trained walking policy                      ║
╚══════════════════════════════════════════════════════════════════════════════╝
        """
    ...
    def display_walking_info(self):
        """Display walking control information"""
        walking_info = """
╔══════════════════════════════════════════════════════════════════════════════╗
║                           🚶 WALKING CONTROL GUIDE                           ║
╠══════════════════════════════════════════════════════════════════════════════╣
║                                                                              ║
║  🧠 AI-Powered Walking:                                                      ║
║     • Values generated by trained RL policies                               ║
║     • Phase-based alternating leg swings                                    ║
║     • Coordinated arm movements for balance                                 ║
║     • Dual-rate control system (60Hz + 1Hz)                                ║
║                                                                              ║
║  🎯 Control System:                                                          ║
║     • Trajectory Controllers: Arms, hips, feet (1Hz)                        ║
║     • Effort Controllers: Knees, elbows, lower legs (60Hz)                  ║
║     • Phase Duration: 0.9 seconds per step                                 ║
║                                                                              ║
║  🔧 Controlled Joints:                                                       ║
║     • Legs: hip, knee, lower_leg, foot (both sides)                        ║
║     • Arms: yaw, pitch, roll, wrist, elbow (both sides)                    ║
║                                                                              ║
║  💡 Tips:                                                                    ║
║     • Ensure robot is properly grounded                                     ║
║     • Monitor balance in Gazebo/RViz                                        ║
║     • Use pelvic girdle for additional stability                           ║
║     • Press Ctrl+C to stop walking                                          ║
║                                                                              ║
╚══════════════════════════════════════════════════════════════════════════════╝
        """
        print(walking_info)
